...
public class PlayerFileReaderCsv implements PlayerFileReader {
  @Override
  public List<Player> readPlayers(Path filePath) throws
      ...
      while ((line = reader.readLine()) != null) {
        ...
        if (parts.length < 2) {
          throw new CsvParsingException(
                  "Invalid player data format at line " + lineNumber + ": " + line
          );
        }
        ...
        try {
          ...
          throw new PlayerDataException(
                  "Invalid playing piece type at line " + lineNumber + ": " + pieceTypeStr, e
          );
        }
